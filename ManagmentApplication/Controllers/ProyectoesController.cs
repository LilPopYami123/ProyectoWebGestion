...
namespace ManagmentApplication.Controllers
{
    public class ProyectoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdProyecto,Nombre,Descripcion,FechaCreacion,FechaFinEstimada,Estado")] Proyecto proyecto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProyecto,Nombre,Descripcion,FechaCreacion,FechaFinEstimada,Estado")] Proyecto proyecto)
        {
